...
/*RXD*/sAGCLNAGAINOFFSET  GSM850_AGCLNA_PATHLOSS_RXD_OFFSET[PLTABLE_SIZE];
/*RXD*/sAGCLNAGAINOFFSET  GSM_AGCLNA_PATHLOSS_RXD_OFFSET[PLTABLE_SIZE];
/*RXD*/sAGCLNAGAINOFFSET  DCS_AGCLNA_PATHLOSS_RXD_OFFSET[PLTABLE_SIZE];
/*RXD*/sAGCLNAGAINOFFSET  PCS_AGCLNA_PATHLOSS_RXD_OFFSET[PLTABLE_SIZE];
/*RXD*/
/*RXD*/sAGCLNAGAINOFFSET*  AGCLNA_PATHLOSS_RXD_OFFSET[FrequencyBandCount] = 
/*RXD*/{
/*RXD*/	0,									 	            /* FrequencyBand400 (not support)	*/
/*RXD*/	GSM850_AGCLNA_PATHLOSS_RXD_OFFSET,	      /* FrequencyBand850 			         */
/*RXD*/	GSM_AGCLNA_PATHLOSS_RXD_OFFSET,		      /* FrequencyBand900 			         */
/*RXD*/	DCS_AGCLNA_PATHLOSS_RXD_OFFSET,		      /* FrequencyBand1800			         */
/*RXD*/	PCS_AGCLNA_PATHLOSS_RXD_OFFSET	         /* FrequencyBand1900 			      */
/*RXD*/};   
   #endif
...
sGGE_TAS_MIPI_RTXCTRL_TABLE GGE_TAS_STATE2_MIPI_CTRL_TABLE_GSM850;
      #if IS_2G_RXD_SUPPORT
sGGE_TAS_MIPI_RTXCTRL_TABLE GGE_TAS_STATE3_MIPI_CTRL_TABLE_GSM850;
...
sGGE_TAS_MIPI_RTXCTRL_TABLE GGE_TAS_STATE2_MIPI_CTRL_TABLE_GSM900;
      #if IS_2G_RXD_SUPPORT
sGGE_TAS_MIPI_RTXCTRL_TABLE GGE_TAS_STATE3_MIPI_CTRL_TABLE_GSM900;
      #endif /* IS_2G_RXD_SUPPORT */
...
sGGE_TAS_MIPI_RTXCTRL_TABLE GGE_TAS_STATE2_MIPI_CTRL_TABLE_DCS1800;
      #if IS_2G_RXD_SUPPORT
sGGE_TAS_MIPI_RTXCTRL_TABLE GGE_TAS_STATE3_MIPI_CTRL_TABLE_DCS1800;
      #endif /* IS_2G_RXD_SUPPORT */
...
sGGE_TAS_MIPI_RTXCTRL_TABLE GGE_TAS_STATE2_MIPI_CTRL_TABLE_PCS1900;
      #if IS_2G_RXD_SUPPORT
sGGE_TAS_MIPI_RTXCTRL_TABLE GGE_TAS_STATE3_MIPI_CTRL_TABLE_PCS1900;
      #endif /* IS_2G_RXD_SUPPORT */
   #endif
...
sGGE_TAS_MIPI_RTXCTRL_TABLE* GGE_TAS_MIPI_CTRL_TABLE[FrequencyBandCount][L1D_TAS_STATE_NUM]=
{
   {0,},                                                          /* FrequencyBand400  */
   {
      ...
      #if IS_2G_RXD_SUPPORT
      &GGE_TAS_STATE3_MIPI_CTRL_TABLE_GSM850,                      /* FrequencyBand850  */
      #endif /* IS_2G_RXD_SUPPORT */
   },
   {
      ...
      #if IS_2G_RXD_SUPPORT
      &GGE_TAS_STATE3_MIPI_CTRL_TABLE_GSM900,                      /* FrequencyBand900  */
      #endif /* IS_2G_RXD_SUPPORT */
   },
   {
      ...
      #if IS_2G_RXD_SUPPORT
      &GGE_TAS_STATE3_MIPI_CTRL_TABLE_DCS1800,                       /* FrequencyBand1800 */
      #endif /* IS_2G_RXD_SUPPORT */
   },
   {
      ...
      #if IS_2G_RXD_SUPPORT
      &GGE_TAS_STATE3_MIPI_CTRL_TABLE_PCS1900                      /* FrequencyBand1900 */
      #endif /* IS_2G_RXD_SUPPORT */
   }
};  
...
#if IS_2G_RXD_SUPPORT
/*RXD*//*For RX PATHLOSS*/
/*RXD*/sAGCGAINOFFSET  AGC_PATHLOSS_RXD_GSM850[PLTABLE_SIZE];
/*RXD*/sAGCGAINOFFSET  AGC_PATHLOSS_RXD_GSM900[PLTABLE_SIZE];
/*RXD*/sAGCGAINOFFSET  AGC_PATHLOSS_RXD_DCS1800[PLTABLE_SIZE];
/*RXD*/sAGCGAINOFFSET  AGC_PATHLOSS_RXD_PCS1900[PLTABLE_SIZE];
/*RXD*/sAGCGAINOFFSET*  AGC_PATHLOSS_RXD_TABLE[FrequencyBandCount] =
/*RXD*/{  0,                                       /* FrequencyBand400 (not support)	*/
/*RXD*/   AGC_PATHLOSS_RXD_GSM850,                 /* FrequencyBand850  */
/*RXD*/   AGC_PATHLOSS_RXD_GSM900,                 /* FrequencyBand900  */
/*RXD*/   AGC_PATHLOSS_RXD_DCS1800,                /* FrequencyBand1800 */
/*RXD*/   AGC_PATHLOSS_RXD_PCS1900                 /* FrequencyBand1900 */
/*RXD*/};
/*RXD*//*For ELNA PATHLOSS*/
/*RXD*/sLNAGAINOFFSET  LNA_PATHLOSS_RXD_GSM850[ PLTABLE_SIZE ]; 
/*RXD*/sLNAGAINOFFSET  LNA_PATHLOSS_RXD_GSM900[ PLTABLE_SIZE ]; 
/*RXD*/sLNAGAINOFFSET  LNA_PATHLOSS_RXD_DCS1800[ PLTABLE_SIZE ];
/*RXD*/sLNAGAINOFFSET  LNA_PATHLOSS_RXD_PCS1900[ PLTABLE_SIZE ]; 
/*RXD*/sLNAGAINOFFSET*  LNA_PATHLOSS_RXD_TABLE[FrequencyBandCount] =
/*RXD*/{  0,                                       /* FrequencyBand400 (not support)	*/
/*RXD*/   LNA_PATHLOSS_RXD_GSM850,                 /* FrequencyBand850  */
/*RXD*/   LNA_PATHLOSS_RXD_GSM900,                 /* FrequencyBand900  */
/*RXD*/   LNA_PATHLOSS_RXD_DCS1800,                /* FrequencyBand1800 */
/*RXD*/   LNA_PATHLOSS_RXD_PCS1900                 /* FrequencyBand1900 */
/*RXD*/};
/*RXD*//*For W Coef.*/
/*RXD*/w_coef                 w_coef_rxd_data[ WCTABLE_SIZE ];
/*RXD*/#ifdef __MTK_TARGET__/*This variable is declared in m11301.c for xL1SIM*/
/*RXD*//*For RxD Custom setting*/
/*RXD*/L1D_CUSTOM_RAS_NVRAM_T L1_RAS_Custom_NVRAM;
/*RXD*/#endif
#endif
