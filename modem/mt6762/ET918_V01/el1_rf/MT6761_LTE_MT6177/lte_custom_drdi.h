...
{                                          \
   {                                       \
      ...
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route38,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route39,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route40,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route41,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route42,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route43,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route44,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route45,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route46,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route47,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route48,  s), \
      LTE_VPA_SOURCE_CONFIG_ROUTE(LTE_Route49,  s), \
   }                                                \
}
