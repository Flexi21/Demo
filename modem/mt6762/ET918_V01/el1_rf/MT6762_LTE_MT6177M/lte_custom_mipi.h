...
/*MIPI ASM     */
/*FDD RX ON    */
#define  LTE_FDD_MIPI_ASM_RX_ON0_SetDefault   US2OFFCNT(10)
...
/*MIPI ASM     */
/*TDD RX ON    */
#define  LTE_TDD_MIPI_ASM_RX_ON0_SetDefault   US2OFFCNT(5) //US2OFFCNT(10)//10 //xen 20171023
...
/*MIPI ASM     */
/*FDD TX ON    */
#if defined(USE_VC7643_12) //xen 20180611
#define  LTE_FDD_MIPI_ASM_TX_ON0_SetDefault   US2OFFCNT(20)
#else
#define  LTE_FDD_MIPI_ASM_TX_ON0_SetDefault   US2OFFCNT(15)
#endif
#define  LTE_FDD_MIPI_ASM_TX_ON1_SetDefault   US2OFFCNT(0)

/*MIPI ASM     */
/*FDD TX OFF    */
// #define  LTE_FDD_MIPI_ASM_TX_OFF0_SetDefault  US2OFFCNT(5)
// #define  LTE_FDD_MIPI_ASM_TX_OFF1_SetDefault  US2OFFCNT(0)
// We do not turn off ASM for FDD mode

/*MIPI ASM     */
/*TDD TX ON    */
#if 0//defined(USE_VC7643_12) //xen 20180611
#define  LTE_TDD_MIPI_ASM_TX_ON0_SetDefault   US2OFFCNT(20)
#else
#define  LTE_TDD_MIPI_ASM_TX_ON0_SetDefault   US2OFFCNT(15)
#endif
#define  LTE_TDD_MIPI_ASM_TX_ON1_SetDefault   US2OFFCNT(0)
...
#else
#define  LTE_FDD_MIPI_PA_TX_ON0_SetDefault    US2OFFCNT(25)
#endif
...
/*TDD TX ON    */
#if 0//defined(USE_VC7643_12) //xen 20180611
#define  LTE_TDD_MIPI_PA_TX_ON0_SetDefault    US2OFFCNT(8)
#else
#define  LTE_TDD_MIPI_PA_TX_ON0_SetDefault    US2OFFCNT(25) 
#define  LTE_TDD_MIPI_PA_TX_ON0_SetDefault_8  US2OFFCNT(8)   //#define US2OFFCNT(us)   ((us)*24)
#endif
...
/*TDD TX OFF    */
#if 0//defined(USE_VC7643_12) //xen 20180611
#define  LTE_TDD_MIPI_PA_TX_OFF0_SetDefault   US2OFFCNT(10)
#else
...
#define  LTE_Band29_MIPI_PA_CCA_SECTION_DATA_SetDefault   LTE_BandNone_MIPI_PA_SECTION_DATA_SetDefault
...
#define  LTE_Band32_MIPI_PA_CCA_SECTION_DATA_SetDefault   LTE_BandNone_MIPI_PA_SECTION_DATA_SetDefault
