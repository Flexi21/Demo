...
const LTE_MIPI_EVENT_TABLE_T LTE_Band6_MIPI_ANTRX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_RX_ON0_SetDefault  }, //PA On
...
const LTE_MIPI_DATA_SUBBAND_TABLE_T LTE_Band6_MIPI_ANTRX_DATA_SetDefault[] =
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ANT , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault   ,{ {  8750 /*100 kHz*/ ,0x00 ,0x02 }, {  8775 /*100 kHz*/ ,0x00 ,0x02 }, {  8800 /*100 kHz*/ ,0x00 ,0x02 }, {  8825 /*100 kHz*/ ,0x00 ,0x02 }, {  8850 /*100 kHz*/ ,0x00 ,0x02 },} },
   { /* 1  */ LTE_MIPI_ANT , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault   ,{ {  8750 /*100 kHz*/ ,0x00 ,0x00 }, {  8775 /*100 kHz*/ ,0x00 ,0x00 }, {  8800 /*100 kHz*/ ,0x00 ,0x00 }, {  8825 /*100 kHz*/ ,0x00 ,0x00 }, {  8850 /*100 kHz*/ ,0x00 ,0x00 },} },
   { /* 2  */ LTE_MIPI_NULL, 0                 , 0             , 0                ,{ {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    }, {     0 /*100 kHz*/ ,0    ,0    },} },
};
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ANT , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault   ,{ {  7290 /*100 kHz*/ ,0x00 ,0x04 }, {  7332 /*100 kHz*/ ,0x00 ,0x04 }, {  7375 /*100 kHz*/ ,0x00 ,0x04 }, {  7417 /*100 kHz*/ ,0x00 ,0x04 }, {  7460 /*100 kHz*/ ,0x00 ,0x04 },} },
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ANT , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault   ,{ {  7460 /*100 kHz*/ ,0x00 ,0x04 }, {  7485 /*100 kHz*/ ,0x00 ,0x04 }, {  7510 /*100 kHz*/ ,0x00 ,0x04 }, {  7535 /*100 kHz*/ ,0x00 ,0x04 }, {  7560 /*100 kHz*/ ,0x00 ,0x04 },} },
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ANT , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault   ,{ {  7340 /*100 kHz*/ ,0x00 ,0x04 }, {  7370 /*100 kHz*/ ,0x00 ,0x04 }, {  7400 /*100 kHz*/ ,0x00 ,0x04 }, {  7430 /*100 kHz*/ ,0x00 ,0x04 }, {  7460 /*100 kHz*/ ,0x00 ,0x04 },} },
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ANT , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault   ,{ {  7170 /*100 kHz*/ ,0x00 ,0x04 }, {  7197 /*100 kHz*/ ,0x00 ,0x04 }, {  7225 /*100 kHz*/ ,0x00 ,0x04 }, {  7252 /*100 kHz*/ ,0x00 ,0x04 }, {  7280 /*100 kHz*/ ,0x00 ,0x04 },} },
...
const LTE_MIPI_EVENT_TABLE_T LTE_Band6_MIPI_ANTTX_EVENT_SetDefault[] =
{
   /* No.     elm type     , data idx       , evt_type           , evt_offset             */
   /*                        { start, stop },                      ( us )                 */
   { /* 0  */ LTE_MIPI_ANT  , { 0    , 0    }, LTE_MIPI_TRX_ON    , LTE_FDD_MIPI_ANT_TX_ON0_SetDefault  }, //PA On
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ANT  , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault    ,{ {  6990 /*100 kHz*/ ,0x00 ,0x04 }, {  7032 /*100 kHz*/ ,0x00 ,0x04 }, {  7075 /*100 kHz*/ ,0x00 ,0x04 }, {  7117 /*100 kHz*/ ,0x00 ,0x04 }, {  7160 /*100 kHz*/ ,0x00 ,0x04 },} }, // PA On PM_Trig: normal mode
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ANT  , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault    ,{ {  7770 /*100 kHz*/ ,0x00 ,0x04 }, {  7795 /*100 kHz*/ ,0x00 ,0x04 }, {  7820 /*100 kHz*/ ,0x00 ,0x04 }, {  7845 /*100 kHz*/ ,0x00 ,0x04 }, {  7870 /*100 kHz*/ ,0x00 ,0x04 },} }, // PA On PM_Trig: normal mode
...
{
   //No.      elm type     , port_sel          , data_seq      , USID             ,{ { subband-0 freq    ,addr ,data }, { subband-1 freq    ,addr ,data }, { subband-2 freq    ,addr ,data }, { subband-3 freq    ,addr ,data }, { subband-4 freq    ,addr ,data },
   { /* 0  */ LTE_MIPI_ANT  , LTE_MIPI_PORT2    , LTE_REG_W     , MIPI_USID_ANT0_SetDefault    ,{ {  7040 /*100 kHz*/ ,0x00 ,0x04 }, {  7070 /*100 kHz*/ ,0x00 ,0x04 }, {  7100 /*100 kHz*/ ,0x00 ,0x04 }, {  7130 /*100 kHz*/ ,0x00 ,0x04 }, {  7160 /*100 kHz*/ ,0x00 ,0x04 },} }, // PA On PM_Trig: normal mode
