...
---------------------------------------------------------------------------*/
#define C2K_ELNA1_CATEGORY_SetDefault			C2K_ELNA_OFF
#define C2K_ELNA2_CATEGORY_SetDefault			C2K_ELNA_OFF
#define C2K_ELNA3_CATEGORY_SetDefault			C2K_ELNA_OFF
#define C2K_ELNA4_CATEGORY_SetDefault			C2K_ELNA_OFF
#define C2K_ELNA5_CATEGORY_SetDefault			C2K_ELNA_OFF
#define C2K_ELNA6_CATEGORY_SetDefault			C2K_ELNA_OFF
#define C2K_ELNA7_CATEGORY_SetDefault			C2K_ELNA_OFF
#define C2K_ELNA8_CATEGORY_SetDefault			C2K_ELNA_OFF
#define C2K_ELNA9_CATEGORY_SetDefault			C2K_ELNA_OFF
#define C2K_ELNA10_CATEGORY_SetDefault			C2K_ELNA_OFF

/*---------------------------------------------------------------------------
Set "GAIN MODE" BPI data for the specific ELNA
---------------------------------------------------------------------------*/
//The setting for ELNA1
#define PDATA_C2K_ELNA1_PIN0_SetDefault			C2K_ELNA_PIN_NONE	//(13)		// the 1st BPI pin number for the ELNA control
...
MML1_FE_ELNA1:			ELAN1 is selected
MML1_FE_ELNA2:			ELAN2 is selected
...
MML1_FE_ELNA12:			ELAN12 is selected
MML1_FE_ELNA_NONE:		ELNA is unused
--------------------------------------------------*/
#define C2K_BAND_A_RX_ELNA_SetDefault	MML1_FE_ELNA_NONE
#define C2K_BAND_B_RX_ELNA_SetDefault	MML1_FE_ELNA_NONE
...
#define C2K_BAND_B_RXD_ELNA_SetDefault	MML1_FE_ELNA_NONE
