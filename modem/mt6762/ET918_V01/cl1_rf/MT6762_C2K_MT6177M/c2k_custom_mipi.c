...
C2K_MIPI_DATA_SUBBAND_TABLE_T C2K_BAND_A_MIPI_RX_DATA_SetDefault[] =
{
   ...
   { /* 1  */ C2K_MIPI_ASM , C2K_MIPI_PORT1    , C2K_REG_W     , MIPI_USID_ASM0_SetDefault   ,{ { 8600  /*100 kHz*/ , {0x00 ,0x14} }, { 8668  /*100 kHz*/ , {0x00 ,0x14} }, { 8736  /*100 kHz*/ , {0x00 ,0x14} }, { 8804  /*100 kHz*/ , {0x00 ,0x14} }, { 8872  /*100 kHz*/ , {0x00 ,0x14} },} },
...
C2K_MIPI_DATA_SUBBAND_TABLE_T C2K_BAND_A_MIPI_TX_DATA_SetDefault[] =
{
   ...
   //{ /* 1  */ C2K_MIPI_PA  , C2K_MIPI_PORT0    , C2K_REG_W     , MIPI_USID_PA1_SetDefault    ,{ { 8150  /*100 kHz*/ , {0x00 ,0x30} }, { 8218  /*100 kHz*/ , {0x00 ,0x30} }, { 8286  /*100 kHz*/ , {0x00 ,0x30} }, { 8354  /*100 kHz*/ , {0x00 ,0x30} }, { 8422  /*100 kHz*/ , {0x00 ,0x30} },} },
   { /* 1  */ C2K_MIPI_PA  , C2K_MIPI_PORT0    , C2K_REG_W     , MIPI_USID_PA1_SetDefault    ,{ { 8150  /*100 kHz*/ , {0x00 ,0x34} }, { 8218  /*100 kHz*/ , {0x00 ,0x34} }, { 8286  /*100 kHz*/ , {0x00 ,0x34} }, { 8354  /*100 kHz*/ , {0x00 ,0x34} }, { 8422  /*100 kHz*/ , {0x00 ,0x34} },} },
...
#endif
   { /* 3  */ C2K_MIPI_PA  , C2K_MIPI_PORT0    , C2K_REG_W     , MIPI_USID_PA1_SetDefault    ,{ { 8150  /*100 kHz*/ , {0x02 ,0x40} }, { 8218  /*100 kHz*/ , {0x02 ,0x40} }, { 8286  /*100 kHz*/ , {0x02 ,0x40} }, { 8354  /*100 kHz*/ , {0x02 ,0x40} }, { 8422  /*100 kHz*/ , {0x02 ,0x40} },} },
   ...
   { /* 6  */ C2K_MIPI_PA  , C2K_MIPI_PORT0    , C2K_REG_W     , MIPI_USID_PA1_SetDefault    ,{ { 8150  /*100 kHz*/ , {0x00 ,0x34} }, { 8218  /*100 kHz*/ , {0x00 ,0x34} }, { 8286  /*100 kHz*/ , {0x00 ,0x34} }, { 8354  /*100 kHz*/ , {0x00 ,0x34} }, { 8422  /*100 kHz*/ , {0x00 ,0x34} },} },
   ...
   { /* 9  */ C2K_MIPI_ASM , C2K_MIPI_PORT1    , C2K_REG_W     , MIPI_USID_ASM0_SetDefault   ,{ { 8150  /*100 kHz*/ , {0x00 ,0x14} }, { 8218  /*100 kHz*/ , {0x00 ,0x14} }, { 8286  /*100 kHz*/ , {0x00 ,0x14} }, { 8354  /*100 kHz*/ , {0x00 ,0x14} }, { 8422  /*100 kHz*/ , {0x00 ,0x14} },} },
...
C2K_MIPI_TPC_SECTION_TABLE_T C2K_BAND_A_MIPI_PA_SECTION_DATA_1XRTT_SetDefault[C2K_MIPI_SUBBAND_NUM] =
{
#if defined(USE_VC7643_12) //xen 20180328
   {
      ...
      MIPI_USID_PA1_SetDefault, /*USID*/
      {
         ...
         // {addr, data}, {addr, data}, {addr, data}, {addr, data}, {addr, data}
          /* 0 */ {{{ 0x1, 0x11}, { 0x2, 0x40}, { 0x3, 0x80}, { 0x0, 0x0 }, { 0x0, 0x0 }}}, //C2K TPC dont add PA ENABLE BIT
          /* 1 */ {{{ 0x1, 0x12}, { 0x2, 0x40}, { 0x3, 0x80}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 2 */ {{{ 0x1, 0x22}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 3 */ {{{ 0x1, 0x33}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 4 */ {{{ 0x1, 0x44}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 5 */ {{{ 0x1, 0x44}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 6 */ {{{ 0x1, 0x55}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 7 */ {{{ 0x1, 0x55}, { 0x2, 0x40}, { 0x3, 0x8B}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
      }
   },
   {
      8218, /*100kHz*/
...
#else
   {
      ...
      MIPI_USID_PA1_SetDefault, /*USID*/
      {
         ...
         // PA_SEC_DATA0, PA_SEC_DATA1, PA_SEC_DATA2, PA_SEC_DATA3, PA_SEC_DATA4
         // {addr, data}, {addr, data}, {addr, data}, {addr, data}, {addr, data}
          /* 0 */ {{{ 0x1, 0x13}, { 0x2, 0x40}, { 0x3, 0x80}, { 0x0, 0x0 }, { 0x0, 0x0 }}}, //C2K TPC dont add PA ENABLE BIT
          /* 1 */ {{{ 0x1, 0x14}, { 0x2, 0x40}, { 0x3, 0x80}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 2 */ {{{ 0x1, 0x15}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 3 */ {{{ 0x1, 0x25}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 4 */ {{{ 0x1, 0x36}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 5 */ {{{ 0x1, 0x46}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 6 */ {{{ 0x1, 0x58}, { 0x2, 0x40}, { 0x3, 0x88}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
          /* 7 */ {{{ 0x1, 0x6A}, { 0x2, 0x40}, { 0x3, 0x8B}, { 0x0, 0x0 }, { 0x0, 0x0 }}},
      }
   },
   {
      8218, /*100kHz*/
