...
/*RX PORT*/
#define TDS_PRX1_Set2       ( 1<<0 )+( 1<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA0,MLB_WOBUF
#define TDS_PRX2_Set2       ( 1<<0 )+( 2<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA1,MLB_WOBUF
#define TDS_PRX3_Set2       ( 1<<0 )+( 3<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA2,MLB_WOBUF
#define TDS_PRX4_Set2       ( 1<<0 )+( 4<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA3,MLB_WOBUF
#define TDS_PRX5_Set2       ( 1<<0 )+( 6<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA5,MLB_WOBUF
#define TDS_PRX6_Set2       ( 1<<0 )+( 5<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA4,MLB_WOBUF
#define TDS_PRX7_Set2       ( 1<<0 )+( 8<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA7,MLB_WOBUF
#define TDS_PRX8_Set2       ( 1<<0 )+( 7<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA6,MLB_WOBUF
#define TDS_PRX9_Set2       ( 2<<0 )+( 1<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA0,HMB_WOQDL
#define TDS_PRX10_Set2      ( 2<<0 )+( 2<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA1,HMB_WOQDL
#define TDS_PRX11_Set2      ( 2<<0 )+( 3<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA2,HMB_WOQDL
#define TDS_PRX12_Set2      ( 2<<0 )+( 4<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA3,HMB_WOQDL
#define TDS_PRX13_Set2      ( 2<<0 )+( 6<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA5,HMB_WOQDL
#define TDS_PRX14_Set2      ( 2<<0 )+( 5<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA4,HMB_WOQDL
/*TX PORT*/
#define TDS_TX_HB1_Set2     ( 0 )
#define TDS_TX_HB2_Set2     ( 1 )
#define TDS_TX_LB1_Set2     ( 3 )
#define TDS_TX_LB2_Set2     ( 4 )
#define TDS_TX_LB3_Set2     ( 5 )
#define TDS_TX_LB4_Set2     ( 7 )
#define TDS_TX_MB1_Set2     ( 10 )
#define TDS_TX_MB2_Set2     ( 11 )
#define TDS_TX_MB3_Set2     ( 12 )
...
/*            14   not used                               */
/*--------------------------------------------------------*/
const T_TD_CUSTOMIZATION_STRUCT    AST_TL1_RF_PARAMETER_DEFAULT_Set2[] = {{
//T_BPI_SETTING
{
