...
/*RX PORT*/
#define TDS_PRX1_SetDefault       ( 1)     // Group1,LNA1,
#define TDS_PRX2_SetDefault       ( 3 )    // Group1,LNA2,
#define TDS_PRX3_SetDefault       ( 4 )    // Group1,LNA3,
#define TDS_PRX4_SetDefault       ( 5 )    // Group1,LNA4,
#define TDS_PRX5_SetDefault       ( 6 )    // Group1,LNA5,
#define TDS_PRX6_SetDefault       ( 7 )    // Group1,LNA6,
#define TDS_PRX7_SetDefault       ( 8 )    // Group1,LNA7,
#define TDS_PRX8_SetDefault       ( 9 )    // Group1,LNA8,
#define TDS_PRXHB_SetDefault      ( 10 )    //LNA9,
#define TDS_PRXLB_SetDefault      ( 2 )    // LNA10,

/*TX PORT*/
#define TDS_TX_TXO1_SetDefault     ( 0 )      
#define TDS_TX_TXO2_SetDefault     ( 9 )     
#define TDS_TX_TXO3_SetDefault     ( 10 )     
#define TDS_TX_TXO4_SetDefault     ( 4 )    
#define TDS_TX_TXO5_SetDefault     ( 5 )     
...
//T_BPI_SETTING
{
    ...
    ////////////TAS//////////////////////////////////////////////////RFconflict////////////////////////////
        ...
        (0)    +(0<<0) + (0<<2) + (0<<5)+ (0<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (0<<16)+ (0<<17) + (1<<31),     //TX_CTRL_BITMASK   data[1] //ANT
    ...
    /////////////TAS////////////////////RFconflict/////////////////////////////////////////////////////////
        ...
        (0)    +(0<<7) + (0<<11) + (0<<12)+ (0<<13)+ (0<<14)+ (0<<15)+ (0<<16)+ (0<<17) + (1<<31),                               //RX_CTRL_BITMASK   data[12] //ANT
...
//T_ABB_APC_VOLT
{
    ...
    0x190,//0x110, //0x156, //0x282,                  //B34 HGv  0.0018V *X
    0x190,//0x8E,  //0xA2, //0x282,                  //B34 MGv  0.0018V *X
    0x190,//0x8E,  //0xA2, //0x282,                  //B34 LGv  0.0018V *X
    0x190,//0x110, //0x156, //0x282,                  //B39 HGv  0.0018V *X
    0x190,//0x8E,  //0xA2, //0x282,                  //B39 MGv  0.0018V *X
    0x190,//0x8E,  //0xA2, //0x282,                  //B39 LGv  0.0018V *X
    0
},

//T_RF_PORT_SEL
{
    TDS_TX_TXO3_SetDefault, //TDS_TX_TXO2_SetDefault,  //Tx2G01
    TDS_TX_TXO3_SetDefault, //TDS_TX_TXO2_SetDefault,  //Tx1G90
    TDS_TX_TXO2_SetDefault,  //Tx2G34
    TDS_PRXHB_SetDefault,    //Rx2G01
    TDS_PRXHB_SetDefault,    //Rx1G90
    TDS_PRXHB_SetDefault,    //Rx2G34
},
...
//T_VPA_VOLT_STRUCT
{
    0x00, //0x33, //Choose PA voltage from PMIC VPA1/VPA2 or External VPA ,default is VPA1
    ...
    8,  //B34,VPA Mid  gain 3.4V
    8,  //B34,VPA Low  gain 3.4V
    34,  //B39,VPA High gain 3.4V
    8,  //B39,VPA Mid  gain 3.4V
    8,  //B39,VPA Low  gain 3.4V
     0
},
//T_ETM_STRUCT
{
...
//#if defined(__TX_POWER_OFFSET_SUPPORT__)
   ...
   {    //uwSwtpPowerOffset q3
       ...
       /*table0*/
       {
              ...
              {9400,     0,     0,       0},/*begin of band 39,donot change */
              {9440,     0,     0,       0},
              {9460,     0,     0,       0},
              {9480,     0,     0,       0},
              {9500,     0,     0,       0},
              ...
              {10050,    0,     0,       0},/*begin of band 34,donot change */
              {10087,    0,     0,       0},
              {10104,    0,     0,       0},
