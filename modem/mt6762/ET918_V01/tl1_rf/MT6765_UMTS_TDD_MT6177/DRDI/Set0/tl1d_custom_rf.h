...
/*RX PORT*/
#define TDS_PRX1_Set0       ( 1<<0 )+( 1<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA0,MLB_WOBUF
#define TDS_PRX2_Set0       ( 1<<0 )+( 2<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA1,MLB_WOBUF
#define TDS_PRX3_Set0       ( 1<<0 )+( 3<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA2,MLB_WOBUF
#define TDS_PRX4_Set0       ( 1<<0 )+( 4<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA3,MLB_WOBUF
#define TDS_PRX5_Set0       ( 1<<0 )+( 6<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA5,MLB_WOBUF
#define TDS_PRX6_Set0       ( 1<<0 )+( 5<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA4,MLB_WOBUF
#define TDS_PRX7_Set0       ( 1<<0 )+( 8<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA7,MLB_WOBUF
#define TDS_PRX8_Set0       ( 1<<0 )+( 7<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group1,LNA6,MLB_WOBUF
#define TDS_PRX9_Set0       ( 2<<0 )+( 1<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA0,HMB_WOQDL
#define TDS_PRX10_Set0      ( 2<<0 )+( 2<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA1,HMB_WOQDL
#define TDS_PRX11_Set0      ( 2<<0 )+( 3<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA2,HMB_WOQDL
#define TDS_PRX12_Set0      ( 2<<0 )+( 4<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA3,HMB_WOQDL
#define TDS_PRX13_Set0      ( 2<<0 )+( 6<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA5,HMB_WOQDL
#define TDS_PRX14_Set0      ( 2<<0 )+( 5<<5 )+( 1<<9 )+( 6<<12 )+( 1<<17 )    // Group2,LNA4,HMB_WOQDL
/*TX PORT*/
#define TDS_TX_HB1_Set0     ( 0 )
#define TDS_TX_HB2_Set0     ( 1 )
#define TDS_TX_LB1_Set0     ( 3 )
#define TDS_TX_LB2_Set0     ( 4 )
#define TDS_TX_LB3_Set0     ( 5 )
#define TDS_TX_LB4_Set0     ( 7 )
#define TDS_TX_MB1_Set0     ( 10 )
#define TDS_TX_MB2_Set0     ( 11 )
#define TDS_TX_MB3_Set0     ( 12 )
...
//T_RF_PORT_SEL
{
    TDS_TX_MB3_Set0,  //Tx2G01
    TDS_TX_MB3_Set0,  //Tx1G90
    TDS_TX_MB3_Set0,  //Tx2G34
    TDS_PRX6_Set0,    //Rx2G01
    TDS_PRX6_Set0,    //Rx1G90
    TDS_PRX6_Set0,    //Rx2G34
},
