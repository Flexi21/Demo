...
{                                                \
   {                                             \
      {                                          \
         UMTS_INTERFERENCE_FREQ_TABLE0_##sET,    \
         UMTS_INTERFERENCE_FREQ_TABLE1_##sET,    \
         UMTS_INTERFERENCE_FREQ_TABLE2_##sET,    \
         UMTS_INTERFERENCE_FREQ_TABLE3_##sET,    \
         UMTS_INTERFERENCE_FREQ_TABLE4_##sET,    \
         UMTS_INTERFERENCE_FREQ_TABLE5_##sET,    \
         UMTS_INTERFERENCE_FREQ_TABLE6_##sET,    \
         UMTS_INTERFERENCE_FREQ_TABLE7_##sET     \
      }                                          \
   }                                             \
}
#endif
