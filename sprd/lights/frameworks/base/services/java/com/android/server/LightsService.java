...
public class LightsService {
    ...
    private final Light mLights[] = new Light[LIGHT_ID_COUNT]; //all led
    ...
    LightsService(Context context) {
        ...
        mNativePointer = init_native(); // init_all led interface
        mContext = context;
    ...
    /* natice function from jni*/
    private static native int init_native(); /*get the led obj*/
