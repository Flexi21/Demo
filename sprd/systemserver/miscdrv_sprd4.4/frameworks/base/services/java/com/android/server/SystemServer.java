...
class ServerThread {
    ...
    public void initAndLoop() {
        ...
        WcnManagerService wcnManager = null; //must init after service of wifi/BT/FM are inited

        //SPRD: Add heartbeat powerguru
        PowerGuruService powerguru = null;
        PowerController powerctl = null;

        // SPRD: Added for optimizing MMI test startup.
        ...
        try {
            ...
            if (APCTOption.self().isApctBootDataSupport())
            {
                long time = SystemClock.uptimeMillis() - time1;
                apct_str += "BOOTING: AMS.main() take:" + time + " ms\n";
            }
            /* @} */
...
//            ServiceManager.addService("telephony.registry", telephonyRegistry);
            ...
            if (!engModeFlag) {// SPRD: Added for optimizing MMI test startup.
            ...
            {
                long time = SystemClock.uptimeMillis() - time1;
                apct_str += "BOOTING: PMS.main take:" + time + " ms\n";
            }
            /* @} */
            ...
            {
                long time = SystemClock.uptimeMillis() - time1;
                apct_str += "BOOTING: AMS.setSystemProcess take:" + time + " ms\n";
            }
            /* @} */
            ...
            try {
                  Slog.i(TAG, "MiscdrvService");
                  ServiceManager.addService("Miscdrv", new MiscdrvService());
            } catch (Throwable e) {
                  Slog.e(TAG, "Failure starting MiscdrvService", e);
            }
        ...
        if (factoryTest != SystemServer.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (!engModeFlag && !disableNonCoreServices) {// SPRD: Added for optimizing MMI test startup.
                try {
        ...
        //SPRD: add for powercontroller (sprd power policy)
        try {
            Slog.i(TAG, "PowerController Service");
            powerctl = new PowerController(context);
        } catch (Throwable e) {
        ...
        {
            long time = SystemClock.uptimeMillis() - time1;
            apct_str += "BOOTING: WMS.SystemReady take:" + time + " ms\n";
        }
        /* @} */
        ...
        {
            long time = SystemClock.uptimeMillis() - time1;
            apct_str += "BOOTING: AMS.SystemReady take:" + time + " ms\n";
        }
        /* @} */
        ...
        if (APCTOption.self().isApctBootDataSupport())
        {
            ...
            apct_str += "BOOTING: SystemServer total take:" + time + " ms\n";
            writeBootDataToProc(apct_str);
        }
        /* @} */
        ...
        /* SPRD: Reduce the frequency of gc when booting */
    ...
    /* SPRD: add for apct functions. */
    public final void writeBootDataToProc(String str)
    {
...
public class SystemServer {
    ...
    public static void main(String[] args) {
        ...
        /* SPRD: Reduce the frequency of gc when booting */
        VMRuntime.getRuntime().setTargetHeapUtilization(0.3f);
        // VMRuntime.getRuntime().setTargetHeapUtilization(0.8f);
        /* @} */
