...
struct miscdrv_device_t {
    ...
    int (*miscdrv_led_ctrl)(int type, int brightness, int on_ms, int off_ms);
    int (*miscdrv_rtc_readtime)(struct tm *tm);
    int (*miscdrv_rtc_settime)(struct tm tm);
    int (*miscdrv_wdt_clk)(int val);
};
