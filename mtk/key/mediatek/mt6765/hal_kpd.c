...
void kpd_get_keymap_state(u16 state[])
{
...
#if defined(LONGPRESS_14S_POWERKEY_REBOOT)
 #undef CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #undef CONFIG_ONEKEY_REBOOT_OTHER_MODE
 #define CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #define CONFIG_ONEKEY_REBOOT_OTHER_MODE
 #undef CONFIG_TWOKEY_REBOOT_NORMAL_MODE
 #undef CONFIG_TWOKEY_REBOOT_OTHER_MODE
 #undef CONFIG_KPD_PMIC_LPRST_TD
 #define CONFIG_KPD_PMIC_LPRST_TD  2 // 14 seconds /* timeout period. 0: 8sec; 1: 11sec; 2: 14sec; 3: 5sec */
#elif defined(LONGPRESS_8S_POWERKEY_REBOOT)
 #undef CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #undef CONFIG_ONEKEY_REBOOT_OTHER_MODE
 #define CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #define CONFIG_ONEKEY_REBOOT_OTHER_MODE
 ...
 #undef CONFIG_TWOKEY_REBOOT_OTHER_MODE
 #undef CONFIG_KPD_PMIC_LPRST_TD
 #define CONFIG_KPD_PMIC_LPRST_TD  0 // 8 seconds
#elif defined(LONGPRESS_5S_POWERKEY_REBOOT)
 #undef CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #undef CONFIG_ONEKEY_REBOOT_OTHER_MODE
 #define CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #define CONFIG_ONEKEY_REBOOT_OTHER_MODE
 ...
 #undef CONFIG_TWOKEY_REBOOT_OTHER_MODE
 #undef CONFIG_KPD_PMIC_LPRST_TD
 #define CONFIG_KPD_PMIC_LPRST_TD  3 // 5 seconds
#elif defined(LONGPRESS_11S_POWERKEY_REBOOT)
 #undef CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #undef CONFIG_ONEKEY_REBOOT_OTHER_MODE
 #define CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #define CONFIG_ONEKEY_REBOOT_OTHER_MODE
 ...
 #undef CONFIG_TWOKEY_REBOOT_OTHER_MODE
 #undef CONFIG_KPD_PMIC_LPRST_TD
 #define CONFIG_KPD_PMIC_LPRST_TD  1 // 11 seconds
#else  //default is 11s reboot
 #undef CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #undef CONFIG_ONEKEY_REBOOT_OTHER_MODE
 #define CONFIG_ONEKEY_REBOOT_NORMAL_MODE
 #define CONFIG_ONEKEY_REBOOT_OTHER_MODE
