...
//#define XXXXX
//static const char *className = "com/example1/android/St7735stime";  
//static const char *className = "com/android/server/policy/PhoneWindowManager";
static const char *className = "com/android/systemui/statusbar/policy/Clock";
